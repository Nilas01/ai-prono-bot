...
# ==========================================
# 🔑 CONFIGURATION DE TON BOT VIA RENDER
# ==========================================
TELEGRAM_TOKEN = os.environ.get("8652808582:AAFS5nG7xFxBpjI8aPMW5Y7Km7ME3Db-rOY")
...
# Dictionnaire intelligent pour détecter le pays et attribuer le bon drapeau
CORRESPONDANCES_PAYS = {
    ...
    "🏴󠁧󠁢󠁥󠁮󠁧󠁿": ["angleterre", "england", "manchester", "city", "united", "arsenal", "liverpool", "chelsea", "tottenham", "newcastle"],
...
async def prono_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # Ajout de tous les sports demandés dans le menu
    options_sports = [
...
async def analyser_le_match(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Récupération automatique des drapeaux correspondants
...
def main():
    if not TELEGRAM_TOKEN or TELEGRAM_TOKEN.startswith("ICI_TU_METS"):
        logging.error("Erreur : Aucun token Telegram valide trouvé dans l'environnement.")
        return
